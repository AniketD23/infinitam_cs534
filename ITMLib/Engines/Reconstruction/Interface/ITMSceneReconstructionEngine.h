	...
	*/
	...
	public:
		...
		*/
		...
		virtual void ResetActiveSceneTracking(ITMScene<TVoxel, ITMVoxelBlockHash> *scene){};
		ITMSceneReconstructionEngine(void) { }
		virtual ~ITMSceneReconstructionEngine(void) { }
		
		int3 bboxMin = make_int3(INT_MAX, INT_MAX, INT_MAX);
		int3 bboxMax = make_int3(INT_MIN, INT_MIN, INT_MIN);
	};
}
