...
ITMLibSettings::ITMLibSettings(void)
        //: sceneParams(0.1f, 100, 0.06f, 0.2f, 4.0f, false), // 6cm
        //: sceneParams(0.1f, 100, 0.04f, 0.2f, 4.0f, false), // 4cm
	: sceneParams(0.1f, 100, 0.02f, 0.2f, 4.0f, false), // 2cm //pyh Ada used config
	//: sceneParams(0.1f, 100, 0.01f, 0.2f, 4.0f, false), // 1cm
	surfelSceneParams(0.5f, 0.6f, static_cast<float>(20 * M_PI / 180), 0.01f, 0.004f, 3.5f, 25.0f, 4, 1.0f, 5.0f, 20, 10000000, true, true)
{
	...
	useBilateralFilter = false; //pyh we disable it because M3D doesn't have this, but adding this won't increaes latency that much
	...
	//pyh We are not using this PID feature in the code so this is not used
